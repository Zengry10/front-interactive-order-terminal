    ...
    function Connect(data){
        ...
        return(
            <div id="changeBgColor" className=" w-screen px-4 h-full  absolute bottom-0 pt-24 flex justify-center">
                <div className="bg-white h-3/5 rounded-lg  relative dark:bg-gray-700 w-96">
                    ...
                    <form className="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8" onSubmit={handleSubmit(Connect)}>
                        <h3 className="text-xl font-medium text-gray-900 dark:text-white">Se connecter sur notre plateforme</h3>
